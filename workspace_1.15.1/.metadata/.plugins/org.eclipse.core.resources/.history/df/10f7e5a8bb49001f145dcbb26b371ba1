    ...
    /* USER CODE END WHILE */
	  if(is_button_pressed(0))
	        ...
	        if(is_button_pressed(2))
	        {
	            led_set(led, false);
	            led = 0;
	            led_set(led, true); // Dodano brakujący kod do zapalenia LED1
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : USER_BUTTON2_Pin USER_BUTTON1_Pin */
  GPIO_InitStruct.Pin = USER_BUTTON2_Pin|USER_BUTTON1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
